package com.foodbodi.utils.picasso_transformation;
 ...
 */
public class RoundCornerImageTransformer implements Transformation {
     ...
     */
    public RoundCornerImageTransformer(final int radius, final int margin) {
        this.radius = radius;
        this.margin = margin;
     ...
     */
    public RoundCornerImageTransformer(final int radius, final int margin, boolean topCornersOnly,
